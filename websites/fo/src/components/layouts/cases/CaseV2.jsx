...
class CaseV2 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            tabportfolio: [
            ...
            portfolioitem: [
                {
                    id: 1,
                    class: 'item travel business consumer',
                ...
                {
                    id: 2,
                    class: 'item business travel financial',
                ...
                {
                    id: 3,
                    class: 'item consumer transport energy',
                ...
                {
                    id: 4,
                    class: 'item financial travel energy',
                ...
                },
                {
                    id: 7,
                    class: 'item consumer transport energy',
                    srcimg: 'images/portfolio/home2/7.jpg',
                    title: 'Financial Services',
                    description: 'Bain helps transportation and logistics companies'
                },
                {
                    id: 8,
                    class: 'item financial travel energy',
                    srcimg: 'images/portfolio/home2/8.jpg',
                    title: 'Transport & Logistics',
                    description: 'Bain helps transportation and logistics companies'
                },
                {
                    id: 9,
                    class: 'item travel business consumer',
                    srcimg: 'images/portfolio/home2/9.jpg',
                    title: 'Travel & Aviation',
                    description: 'Bain helps transportation and logistics companies'
                },
            ]
            ...
            <section className="main-content bg-sidebar sidebar-left">
                <div className="container">
                    <div className="case">
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                <div className="flat-portfolio v2">                         
                                    <ul className="portfolio-filter clearfix">
                                        {
