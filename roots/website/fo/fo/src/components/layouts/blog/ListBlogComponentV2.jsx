...
class ListBlogComponentV2 extends Component {
    render() {
        return (
            <div className="post-wrap blog-v2 clearfix">
                {
                    dataBlog.map(data=>(
                        <article key={data.id} className="entry clearfix">
                            <div className="feature-post v2">
                                <Link to="#"><img src={data.srcimg2} alt="f&o" /></Link>
                            </div>
                            <div className="content-post">
                                ...
                                <div className="submit-wrap">
                                    <button className="flat-button button-style"><Link className="btn2" to="/blog-single" onClick={() => {window.location.href="/blog-single"}}>Read More</Link><i className="fa fa-chevron-right"></i></button>
                                </div>
                            </div>
                        </article>
                        ))
...
export default ListBlogComponentV2;